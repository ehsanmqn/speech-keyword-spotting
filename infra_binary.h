...
//
 ...
 template<> struct binaryTraits<infra::svector> {
   static const char header = 's';
 };
 ...
 */
 ...
 //----------------------------------------------------------------------------
 /** Saves an infra::svector to a file using the binary file format.
     @param stream The file stream to save to
     @param s A constant reference to the svector being saved
 */
 void save_binary(FILE* stream, const infra::svector& s);
...
//----------------------------------------------------------------------------
/** Loads an infra::svector from file using the binary file format
    @param stream The file stream to load from
    @param d A reference to the matrix being loaded
*/
 void load_binary(FILE* stream, infra::svector& s);
