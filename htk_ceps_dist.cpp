...
//		htk_stats = "";
//		std::cout << "Info: input HTK file " << htk_filename << ", output file " << out_filename << std::endl;
//	}
//	else if (rc != 3) {
//		cmdline.print_help();
//		return EXIT_FAILURE;
...
//			mfcc_std = tmp1.row(1);
//			//cout << "Info: load feature statistics from " << htk_stats << endl;
//		}
...
//		cerr << "Cannot open input file " << htk_filename  << "." << endl;
//		return EXIT_FAILURE;
//	}
